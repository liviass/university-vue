<template>
  <div>
    <div>
      ...
      <p>
        <strong>Response code:{{ pending }},{{ error }}, {{ status }}</strong>
      </p>
...
const getSearchURL = (country = 'Canada', name) => {
  ...
  return name ? `${BASE_URL}?country=${country}&name=${name}` : `${BASE_URL}?country=${country}`;
}

// TODO: Armazenar em outro lugar. Lista obtida como resultado do endpoint http://universities.hipolabs.com/search
// Manter ela ordenada por ordem alfabética
const countries = [
